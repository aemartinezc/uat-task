@extends('layouts.app')
@section('title', 'Añadir nuevo grupo')
@section('main')
...
<ol class="breadcrumb p-0">
    ...
    <li>
        <a href="/grupos">Todos los grupos</a>
    </li>
    <li class="text-muted">
        Nuevo grupo
    </li>
...
<div class="card">
    ...
    <div class="card-body">
          <div class="form-group row">
              ...
              <div class="col-sm-6">
                  <input type="text" class="form-control" id="nombre" placeholder="Escriba nombre del grupo" value="@isset($grupo) {{ $grupo->nombre }} @endisset" required>
                  <div class="invalid-feedback">
                    Por favor ingrese nombre del grupo
                  </div>
              </div>
          </div>
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <select class="form-control multiple" id="id_proyecto" required>
                    @isset($grupo)
                      <option value="{{$grupo->id_proyecto}}">{{$grupo->obtenerProyecto->nombre}}</option>
                    @else
      ...
      <div class="card-footer text-center">
          ...
          <a class="btn btn-secondary" href="/grupos"> Volver</a>
      </div>
    </form>
</div>
      ...
      form.addEventListener('click', function (event) {
        if (!form.checkValidity()) {
          ...
          $.ajax({
                 ...
                 url:"{{ ( isset($grupo) ) ? '/grupos/update' : '/grupos/create' }}", //si existe usuarios manda la ruta de usuarios el id del usario sino va mandar usuarios crear
                 headers: {
